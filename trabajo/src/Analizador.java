 ...
 */
public final class Analizador extends StopwordAnalyzerBase {
     ...
     */
    public Analizador(CharArraySet stopwords) {
     ...
     */
    public Analizador(CharArraySet stopwords, CharArraySet stemExclusionSet) {
        super(stopwords);
